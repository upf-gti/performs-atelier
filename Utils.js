...
// THREEjs, disposes object and children, freeing memory 
...
// does not copy, does not clone, does not check whether keys exist
function objectConcat( objectReceptor, objectGiver ){
    for( let a in objectGiver ){
        objectReceptor[a] = objectGiver[a];
    }
